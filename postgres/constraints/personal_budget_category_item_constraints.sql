...
ALTER TABLE personal_budget_category_item ADD constraint unique_category_items_per_category_per_user EXCLUDE USING gist (user_id WITH =, category_item_id WITH =, personal_budget_category_id WITH =);
